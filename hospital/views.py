...
#for showing signup/login button for admin(by Mahesh)
...
#for showing signup/login button for doctor(by Mahesh)
...
#for showing signup/login button for patient(by Mahesh)
...
#-----------for checking user is doctor , patient or admin(by Mahesh)
def is_admin(user):
